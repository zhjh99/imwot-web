		...
		jQuery(this).click(function(){
			...
			if(jQuery(this).parent('li').length>0){
				if(jQuery(this).parent('li').parent('ul').parent('li').length>0){
					jQuery('.iconmenu ul li.current').each(function(){
						jQuery(this).removeClass('current');
					});
					jQuery(this).parent('li').parent('ul').parent('li').attr("class", "current");
					jQuery(this).parent('li').attr("class", "current");
				}else{
...
//			if(c != 'default') {
//				jQuery('head').append('<link id="addonstyle" rel="stylesheet" href="/assets/frame/css/style.'+c+'.css" type="text/css" />');
//				jQuery.cookie("addonstyle", c, { path: '/' });
//			}
//		} else {
//			if(c != 'default') {
//				jQuery('#addonstyle').attr('href','/assets/frame/css/style.'+c+'.css');
//				jQuery.cookie("addonstyle", c, { path: '/' });
//			} else {
